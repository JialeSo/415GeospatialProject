...
3.  **Optimize mobility services** by understanding possible bottlenecks in district flows.

4.  **Develop a scalable framework** that other cities can use to address similar urban mobility challenges.
...
2.  **Supporting Datasets**
    ...
    -   **Weather API [(Weatherbit)](https://www.weatherbit.io/):** Supplements our analysis with weather categories to allow for analysis of Grab Demand according to the presence or absence of rain.
...
3.  ***Traffic Flow Analysis**, desire line maps will be used to visualize movement patterns between key POIs, providing insights into frequently traveled routes. This analysis will also help identify bottlenecks, optimal travel routes, and how different POIs influence commuting behavior during different times of the day.*

4.  ***Geographically Weighted Regression (GWR)**, will further deepen the analysis by examining how demographic factors, proximity to POIs, and traffic conditions influence ride-hailing demand within different neighborhoods. This regression technique will detect spatial variations in the significance of these factors, revealing how demand shifts across various areas of the city.*
